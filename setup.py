...
setup(name 				= 'SI1145',
	  ...
	  description		= 'Library for accessing the SI1145 UV sensor on a Raspberry Pi. Uses Adafruit GPIO I2C. Credit to Tony Dicola as used his BMP library.  Also credit to Adafruit for TMP007 Arduino library',
	  license			= 'MIT',
